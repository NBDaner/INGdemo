...
[assembly: Xamarin.Forms.Dependency(typeof(INGdemo.UWP.Lib.AudioServiceImpl1))]
namespace INGdemo.UWP.Lib
{
    ...
    class AudioServiceImpl1 : ISBCAudio
    {
        private AudioGraph graph;
        private AudioDeviceOutputNode deviceOutputNode;
        private AudioFrameInputNode frameInputNode;
        ...
        async public void Play1(int samplingRate)
        {
            System.Diagnostics.Debug.WriteLine("Play1");  
            Stop1();
            FrameAdded = 0;
            FrameCompleted = 0;
            SamplingRate = (uint)samplingRate;
        ...
        public void Stop1()
        {
            System.Diagnostics.Debug.WriteLine("Stop1");
            if (graph == null) return;
            graph.Stop();
            graph.Dispose();
            graph = null;
